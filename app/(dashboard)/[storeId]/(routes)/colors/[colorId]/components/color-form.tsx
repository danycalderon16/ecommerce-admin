...
export const ColorForm: React.FC<ColorFormProps> = ({ initalData }) => {
  ...
  const description = initalData ? "Edit Color" : "Add a new Color";
  const toastMessage = initalData ? "Color update" : "Color created";
  const action = initalData ? "Save changes" : "Create Color";
