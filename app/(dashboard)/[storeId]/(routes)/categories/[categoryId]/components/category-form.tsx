...
export const CategoryForm: React.FC<CategoryFormProps> = ({ initalData, billboards }) => {
  ...
  const description = initalData ? "Edit Category" : "Add a new Category";
  const toastMessage = initalData ? "Category update" : "Category created";
  const action = initalData ? "Save changes" : "Create Category";
